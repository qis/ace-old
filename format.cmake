...
foreach(file_absolute ${sources})
  ...
  if(WIN32)
    execute_process(COMMAND "C:/Program Files/LLVM/bin/clang-format.exe" -i ${file_relative})
  else()
    execute_process(COMMAND "/mnt/c/Program Files/LLVM/bin/clang-format.exe" -i ${file_relative})
  endif()
