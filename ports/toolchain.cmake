...
if(WIN32)
  set(CMAKE_C_FLAGS_DEBUG "/Od /sdl /RTC1 /Zi" CACHE STRING "" FORCE)
  set(CMAKE_C_FLAGS_RELWITHDEBINFO "/O1 /Oi /GS- /Zi" CACHE STRING "" FORCE)
  ...
  foreach(LINKER SHARED_LINKER MODULE_LINKER EXE_LINKER)
    set(CMAKE_${LINKER}_FLAGS_DEBUG "/OPT:REF /OPT:ICF /DEBUG:FULL /INCREMENTAL:NO" CACHE STRING "" FORCE)
    set(CMAKE_${LINKER}_FLAGS_RELWITHDEBINFO "/OPT:REF /OPT:ICF /DEBUG:FULL /INCREMENTAL:NO" CACHE STRING "" FORCE)
  endforeach()  
else()
