...
if(WIN32)
  ...
  set(CMAKE_C_FLAGS_RELWITHDEBINFO "/O1 /Oi /GS- /ZI /JMC /D_DEBUG" CACHE STRING "")
  ...
  foreach(LINKER SHARED_LINKER MODULE_LINKER EXE_LINKER)
    ...
    set(CMAKE_${LINKER}_FLAGS_RELEASE "/OPT:REF /INCREMENTAL:NO /LTCG" CACHE STRING "")
    set(CMAKE_${LINKER}_FLAGS_MINSIZEREL "/OPT:REF /OPT:ICF /INCREMENTAL:NO /LTCG" CACHE STRING "")
    set(CMAKE_${LINKER}_FLAGS_RELWITHDEBINFO "/OPT:REF /DEBUG:FASTLINK" CACHE STRING "")
  endforeach()
  ...
  set(CMAKE_RC_FLAGS_RELWITHDEBINFO_INIT "/D_DEBUG")
  ...
  set(CMAKE_C_FLAGS_RELWITHDEBINFO "-O2 -g -D_DEBUG" CACHE STRING "")
